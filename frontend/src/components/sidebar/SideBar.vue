<template>
  <div class="sidebar" :data="backgroundColor">
    <div class="sidebar-wrapper" id="style-3">
      <div class="w-100">
        <div class="logo">
          <div @click.stop="goHome" aria-label="sidebar mini logo" class="simple-text logo-mini">
            <div class="logo-img logo-img-rtl">
              <img
          ...
          <div @click.stop="goHome" aclass="simple-text logo-normal">
            {{ title }}
          </div>
        </div>
      </div>
      ...
      <div class="w-100">
        <ul class="nav">
          ...
          <slot name="links">
            <sidebar-link v-for="link of sidebarLinks" :key="link.route" :to="link.route" :name="link.label"
              :icon="link.icon">
            </sidebar-link>
          </slot>
        </ul>
